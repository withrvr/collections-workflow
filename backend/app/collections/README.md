...
Status: **Phase 5 (Control gate and deterministic summary) complete**. This README
...
a deterministic plain-English narrative either way — no LLM yet (Phase
6). See `docs/CHANGELOG.md` for what each phase adds.
...
- **142 tests** (`uv run pytest app/collections/tests -v`): loader/resolver
