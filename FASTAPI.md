> **This is the base template's own README, kept unmodified for reference.**
> This repo is the **ERP Collection Reporting Workflow** — see
> [`README.md`](README.md) at the repo root for what it actually is.
> MASTER_PLAN.md section 4: *"Base: clone
> `fastapi/full-stack-fastapi-template`, commit unchanged... everything
> after that is your diff."* This file is that unchanged base commit's
> own documentation, not ours — still accurate for the underlying stack
> (FastAPI/SQLModel/React/Docker Compose) this project is built on, and
> the source for `development.md`/`deployment*.md`'s stack-level (not
...
Check the file [FASTAPI-release-notes.md](./FASTAPI-release-notes.md)
(renamed from `release-notes.md` in this fork — see the note at the top
of that file).
